...
public class StaffRoleDao extends BaseDao {
	...
	public List<StaffRole> getListByEnName(String enName){
		String hql = "from StaffRole where roleEnName= :enName";
		List<StaffRole> staffRoles = getSessionFactory().getCurrentSession().createQuery(hql).setParameter("enName", enName).list();
		return staffRoles;
	}
