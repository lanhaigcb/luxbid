...
import com.mine.common.enums.C2CExOrderStatus;
import com.mine.common.enums.ExOrderType;
...
@RequestMapping("/c2cBuyOrder")
public class C2CBuyOrderController extends BaseController {
    @Autowired
    ...
    public ModelAndView index() {
        ModelAndView mv = new ModelAndView("c2cBuyOrder/index");
    ...
    public Object list(Integer customerId, String account, Integer startMinute,
        ...
        if (Strings.isNullOrEmpty(status)){
            status = "EX_ORDER_STATUS_PAY";
        }
        if (Strings.isNullOrEmpty(type)){
            type = "EX_ORDER_TYPE_BUY";
        }
    ...
    public String see(ModelMap modelMap, Integer id) {
        ...
        C2CExchangeOrderVo orderVo = c2cExchangeOrderService.get(id);
        modelMap.addAttribute("picUrl", orderVo.getPicUrl());

        return "c2cBuyOrder/pic";
