...
<script type="text/javascript" charset="UTF-8">
                ...
                $("#exchangeOrderTable").bootstrapTable({
                    ...
                    columns: [{
                        ...
                        formatter: function (value, row, index) {
                            var html = "";
                            html += "<input type='button' class='btn btn-primary' onclick='see(" + row.id + ")'  value='查看'>";
                            return html;
                        }
                    }*/, {
                        title: '操作',
    ...
    function cancel(id) {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['600px', '200px'],
            content: 'c2cBuyOrder/op?id='+id+'&type=cancel'
        });
    }
    ...
    function done(id) {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['600px', '200px'],
            content: 'c2cBuyOrder/op?id='+id+'&type=done'
        });
