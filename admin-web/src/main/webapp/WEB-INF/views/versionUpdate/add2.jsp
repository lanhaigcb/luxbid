...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal m-t" method="post" id="versionUpdateAddForm2" action = "versionUpdate/add2" enctype="multipart/form-data">
    ...
    <script>
        ...
        $(function (){
            ...
            $('#versionUpdateAddForm2').ajaxForm(options);
