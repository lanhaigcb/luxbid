                ...
                <div class="col-sm-12">
                    <div class="panel-body" style="padding-bottom:0px;">
                            ...
                            <div class="panel-body">
                                <form id="formSearch" class="form-horizontal">
                                    <div class="form-group" style="margin-top:15px">
                                        ...
                                        <label class="control-label col-xs-1" for="helpCategoryId" style="margin-left: -20px">标题分类：</label>
                                        <div class="col-sm-2">
                                            <select id="helpCategoryId" class="form-control">
                        ...
                        <div class="btn-group hidden-xs" id="tableToolbar" role="group">
                            ...
                            <fn:func url="helpDetail/addInput">
                                <button type="button" id="add" class="btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true">新增详情</i>
                                </button>
                            </fn:func>
                            <fn:func url="helpDetail/updateInput">
                                <button type="button" id="update" class="btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-pencil" aria-hidden="true">更新详情</i>
                                </button>
                            </fn:func>
                        </div>
...
<script type="text/javascript" charset="UTF-8">
    ...
    $("#update").click(function () {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['80%', '90%'],
            content: 'helpDetail/updateInput?id='+rows[0].id
        });
    });
</script>
</body>
