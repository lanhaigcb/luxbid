        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal m-t" method="post" id="updateForm" action = "helpDetail/update" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select id="helpCategoryId" name="helpCategoryId" class="form-control">
                                        <c:forEach var="v" items="${categoryVoList}" >
                                            <option  <c:if test="${categoryVo.helpCategoryId== v.id}">selected="selected"</c:if> value="${v.id}" >${v.category}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="title" name="title" class="form-control" type="text" value="${categoryVo.title}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                     <textarea id="content" name="content" required='true' maxlength="5000"
                                               ...
                                               style="width: 830px;float: left;height: 300px" >${categoryVo.content}</textarea>
                                </div>
                            </div>
