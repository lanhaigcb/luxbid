                            ...
                            <div class="panel-body">
                                <form id="formSearch" class="form-horizontal">
                                    <div class="form-group" style="margin-top:15px">
                                        ...
                                        <label class="control-label col-xs-1" for="customerId"
                                               style="margin-left: -20px">客户归属：</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="inviteeId" name="inviteeId"
                                                   placeholder="代理商ID">
                                        </div>
                                    ...
                                    <div class="form-group" style="margin-top:15px">
                                        ...
                                        <label class="control-label col-xs-1" for="remark" style="margin-left: -20px">平仓类型：</label>
                                        <div class="col-sm-2">
