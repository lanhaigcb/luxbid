...
<div class="middle-box text-center loginscreen  animated fadeInDown">
  <div>
    ...
    margin-top:5%;width: 100%;" onclick="loadimage();"/>
      ...
      <div class="form-group">
        <input type="text" class="form-control " name="typeCode" id="typeCode"  placeholder="短信验证码">
        <div class="col-sm-4 col-sm-offset-9">
      ...
      <button type="submit" class="btn btn-primary block full-width m-b" style="background-color: #337ab7;border-color: #2e6da4;"  onclick="login();">登录</button>
            <p class="text-muted text-center"><a href="auth/toLoginView?type=GOOGLE">我已绑定谷歌验证码，使用谷歌验证码登陆</a>
            </p>
    </form>
  </div>
</div>
