...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    ...
    margin-top:5%;width: 100%;" onclick="loadimage();"/>
            ...
            <div class="form-group">
                <input type="text" class="form-control " name="typeCode" id="typeCode" placeholder="谷歌验证码">
            </div>

            <span style="color: red">${error}</span>
            <button type="submit" class="btn btn-primary block full-width m-b"
                    style="background-color: #337ab7;border-color: #2e6da4;" onclick="login();">登录
            </button>
            <p class="text-muted text-center"><a href="auth/toLoginView?type=SMS">我还没绑定谷歌验证码，使用短信登陆</a>
            </p>
        </form>
    </div>
</div>
