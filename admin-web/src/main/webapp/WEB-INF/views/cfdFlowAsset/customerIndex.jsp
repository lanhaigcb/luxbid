                            ...
                            <div class="panel-body">
                                <form id="formSearch" class="form-horizontal">
                                    <div class="form-group" style="margin-top:15px">
                                        ...
                                        <label class="control-label col-xs-1" for="mobile" style="margin-left: -20px">用户ID：</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="customerId" name="customerId"
                                                   placeholder="用户ID">
                                        </div>
                                        <label class="control-label col-xs-1" for="mobile" style="margin-left: -20px">客户归属：</label>
                                        <div class="col-sm-2">
...
<script type="text/javascript" charset="UTF-8">
    ...
    (function ($) {
        ...
        $("#search").on("click", function () {
            if (isFirst) {
                ...
                $("#exchangeOrderTable").bootstrapTable({
                    ...
                    url: "cfdFlowAsset/customerFlowAssetlist",
                    pagination: true,
        ...
        $("#export").click(function () {
            ...
            window.location.href = "cfdFlowAsset/customerExport?" +
