        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal m-t" method="post" id="updatePartitionForm" action = "exchangePartition/update" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">分区名称：</label>
                            <div class="col-sm-8">
                                <input id="id" name="id" class="form-control" value="${vo.id}" type="hidden">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="sortParameter" name="sortParameter" class="form-control" value="${vo.sortParameter}" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                 <textarea id="introduce" name="introduce" required='true' maxlength="5000"
                                           ...
                                           style="width: 830px;float: left;height: 300px">${vo.introduce}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    $(function (){
        ...
        $('#updatePartitionForm').ajaxForm(options);
