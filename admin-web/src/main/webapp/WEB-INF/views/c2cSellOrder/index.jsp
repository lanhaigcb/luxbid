                                    ...
                                    <div class="form-group" style="margin-top:15px">
                                        ...
                                        <div class="col-sm-2">
                                            <select id="status" name="status" class=" form-control">
                                                ...
                                                <option value="EX_ORDER_STATUS_TRADE">交易中</option>
                                                <option value="EX_ORDER_STATUS_REMIT">待打款卖单</option>
                                            </select>
                                        </div>
...
<script type="text/javascript" charset="UTF-8">
    ...
    function cancel(id) {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['600px', '200px'],
            content: 'c2cSellOrder/op?id='+id+'&type=cancel'
        });
    }
    ...
    function done(id) {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['600px', '200px'],
            content: 'c2cSellOrder/op?id='+id+'&type=done'
        });
