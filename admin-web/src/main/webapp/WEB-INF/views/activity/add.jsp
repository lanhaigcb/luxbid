...
<html>
    ...
    <script src="../../../theme/js/custom/staff/form-validate-activity.min.js"></script>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal m-t" method="post" id="addForm" action = "act/add" enctype="multipart/form-data">
